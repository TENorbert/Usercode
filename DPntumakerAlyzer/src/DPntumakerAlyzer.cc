...
// $Id: DPntumakerAlyzer.cc,v 1.4 2012/04/23 19:28:49 sckao Exp $
//
//
...
bool DPntumakerAlyzer::PhotonSelection( Handle<reco::PhotonCollection> photons, Handle<EcalRecHitCollection> recHitsEB, Handle<EcalRecHitCollection> recHitsEE, vector<const reco::Photon*>& selectedPhotons ) {
